...
모션의 근거는 [모션](.claude/docs/design/decisions/motion.md)이 갖는다.

**한다**

- 모션은 상태 변화를 설명하는 것만 둔다.
